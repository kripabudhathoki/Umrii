                                    ...
                                    <td colspan="7">
                                        <table class="table table-sm table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                $itemSql = "SELECT p.product_image, p.product_name, oi.quantity, oi.unit_price, (oi.quantity * oi.unit_price) AS subtotal
                                                            FROM order_items oi
                                                            JOIN products p ON oi.pid = p.pid
...
include('footer.php')?>
    ...
    <!-- Bootstrap JS -->
    <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.18.9/dist/umd/popper.min.js"></script>
